...
//Name: refbase.ma
//Last modified: Mon, Aug 11, 2008 03:08:39 PM
//Codeset: UTF-8
...
file -rdi 1 -ns "subrefbase" -rfn "subrefbaseRN" "$MAYAFILEBASE/ma/subrefbase.ma";
file -rdi 2 -ns "cube" -rfn "subrefbase:cubeRN" "$MAYAFILEBASE/ma/cube.ma";
file -rdi 2 -ns "cylinder" -rfn "subrefbase:cylinderRN" "$MAYAFILEBASE/ma/cylinder.ma";
file -rdi 2 -ns "sphere" -rfn "subrefbase:sphereRN" "$MAYAFILEBASE/ma/sphere.ma";
...
file -r -ns "subrefbase" -dr 1 -rfn "subrefbaseRN" "$MAYAFILEBASE/ma/subrefbase.ma";
requires maya "8.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -14.975600972043107 16.209982832530748 17.020067511700965 ;
	setAttr ".r" -type "double3" -31.538352729598458 -41.399999999997441 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 27.532360130722285;
...
createNode reference -n "sphereRN";
	...
	setAttr ".ptag" -type "string" "";
lockNode;
createNode reference -n "subrefbaseRN";
	setAttr ".fn[0]" -type "string" "/home/sebastian/whitesharkstd/trunk/ext/byronimo/py/byronimo/maya/test/ma/subrefbase.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
		"subrefbaseRN"
		"subrefbaseRN" 0
		"subrefbase:cubeRN" 0
		"subrefbase:cylinderRN" 0
		"subrefbase:sphereRN" 0;
	setAttr ".ptag" -type "string" "";
lockNode;
...
connectAttr "sharedReferenceNode.sr" "subrefbaseRN.sr";
