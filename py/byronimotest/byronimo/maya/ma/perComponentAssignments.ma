...
//Last modified: Thu, Oct 09, 2008 05:34:55 PM
//Codeset: UTF-8
requires maya "8.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -25.79729041586025 48.046922035912381 -54.3279880136866 ;
	setAttr ".r" -type "double3" -29.738352729604671 -180.19999999998086 0 ;
...
connectAttr "s1.iog.og[3]" "sg4.dsm" -na;
connectAttr "s1.iog.og[4]" "sg4.dsm" -na;
