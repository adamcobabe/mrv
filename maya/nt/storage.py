...
# produce actual code ?
if os.environ.get(persistence.persistence_enabled_envvar, 1):
	...
	class StorageBase( iDuplicatable ):
		...
		def _clearData( self, valueplug ):
			...
			# for an MPlug
			plugindataobj = api.MFnPluginData( ).create( persistence.PyPickleData.kPluginDataId )
	...
	#} END storage access
# END if code should be compiled
