...
_should_initialize_plugin = int(os.environ.get(persistence_enabled_envvar, True))


__all__ = ['persistence_enabled_envvar']
...
# optimize load times, this kicks in only if mpx is not imported.
if _should_initialize_plugin:
	...
	__all__.extend(('PyPickleData', 'addStorageAttributes' ))
