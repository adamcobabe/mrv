...
import unittest
import byronimotest.mayarv.automation.processes as process # assure procs are initialized
...
def init_loadWorkflows( ):
	_this_module = __import__( "byronimotest.mayarv.automation.workflows", globals(), locals(), ['workflows'] )
...
def get_suite( ):
	...
	# custom setup
	import byronimotest.mayarv.automation.workflows as self
